...
function Compare-Groups {
    ...
    $compareFunc = {
        ...
        # Compare expressions — exclude ConjunctionOperator entries which are
        # auto-generated by NSX as glue between real expressions and may differ
        # in count or content between source and destination without indicating
        # a real migration problem.
